...
| Metrica | Valore | Note |
|---|---|---|
| CapEx Y1 6A baseline | **€700-1200k** | + IVA + contingency 15% → €975k-1.96M; sliding realistic €2.5-3.5M |
| OpEx run-rate Y2+ | **€1.18M/anno** | Include +3 FTE regulatory team obbligatori post Cap.5 §5.17 |
| Revenue Y1 baseline | **€260k** (RECALIBRATED) | Pricing PA €75k/anno (vs €150k originale falsificato da Cluster D) |
| Break-even cumulato | **Y4-Y5** baseline / Y6-Y7 sliding | Dipende esecuzione Y1-Y3 |
| NPV 10y (WACC 12%) | **+€3.5M** scenario base | Worst -€2M / Best +€25M |
| Capital intensity 10y small fleet (5-10 HAPS) | **€500M-€2B** | Scenario "standalone IT operator small fleet" (B2-relaxed) |
| Capital intensity 10y EU sovereign full scale (100+ HAPS) | **€10-30B** | Richiede programma EU equivalente IRIS² come precondizione esterna |
...
**Firma CEO**: ________________
**Firma CdA**: ________________
**Firma Sponsor istituzionale (Coopfond)**: ________________
**Firma Sponsor istituzionale (Regione Liguria)**: ________________
