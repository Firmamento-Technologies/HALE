...
> Volume 3 — Studio di Fattibilità Firmamento Technologies
> Sezione R.1: Norme UE + IT + autorità regolatorie
...
[N-03] **D.Lgs. 18 aprile 2016, n. 50** — *Codice dei contratti pubblici (abrogato)* — per riferimenti pre-2023.
...
[N-17] **ENAC Piano Strategico Nazionale Advanced Air Mobility (AAM) 2021-2030** + Allegato 1 Roadmap + Allegato 2 Business Plan. Sources: `fonti/01_Piano-Strategico-Nazionale-AAM_ENAC_web-1.md`, `fonti/02_AAM-Italian-Ecosystem-Roadmap_web-1.md`, `fonti/03_AAM-Business-Plan_web-1.md`. Confidence: **high**.
...
[N-21] **Codice della Navigazione** (R.D. 327/1942 aggiornato) — Disciplina spazio aereo. art. 793-794: sorvolo bassa quota + aree militari.

## R.1.4 Spettro radio

[N-22] **D.Lgs. 1° agosto 2003, n. 259** — *Codice delle Comunicazioni Elettroniche* (come novellato dal D.Lgs. 207/2021).

[N-23] **D.Lgs. 8 novembre 2021, n. 207** — Aggiornamento Codice Comunicazioni Elettroniche.

[N-24] **Piano Nazionale di Ripartizione delle Frequenze (PNRF)** — Gestito da MIMIT, aggiornato post-WRC-23.

[N-25] **ITU Radio Regulations 2024** (Edition 2024, basata WRC-23) — Bande HAPS art. 5 + Risoluzioni 122 (WRC-19), 122-bis (WRC-23). [ITU-R Radio Regulations](https://www.itu.int/pub/R-REG-RR).

[N-26] **AGCOM Delibera n. 93/26/CONS** del 14 aprile 2026 — *Pianificazione frequenze banda UHF da rete nazionale n.12 PNAF-DVB*. Source: `fonti/Delibera 93-26-CONS.md`. Confidence: **high** (template AGCOM, non specifico HAPS).

## R.1.5 Privacy e protezione dati personali
...
- Provv. n. 405 del 4 luglio 2024 (drone Treviso TrevisoSicura) — sanzione €7.000. [doc 10050298](https://www.garanteprivacy.it/home/docweb/-/docweb-display/docweb/10050298)
- Provv. settembre/giugno/gennaio 2025 — pattern €5-8k a PA per droni senza adeguata base GDPR
- Pagina tematica "Droni" (2024-2025). [link](https://www.garanteprivacy.it/temi/droni)
...
[N-33] **Legge 132/2025** — Adattamento italiano AI Act.
...
[N-41] **Direttiva 2014/34/UE (ATEX)** — *Equipment in Explosive Atmospheres* — Per storage batterie LiS.
...
## R.1.8 Strategic / Sovranità

[N-50] **D.L. 15 marzo 2012, n. 21 (Golden Power)** — Poteri speciali Governo su settori strategici incluso aerospazio, telecomunicazioni, dual-use.

[N-51] **DPCM 18 dicembre 2020** — Estensione perimetro Golden Power a tecnologie strategiche aerospace + dual-use.

[N-52] **DPCM novembre 2024** + DPCM aggiornamenti 2025-2026 — Golden Power applicazione.

[N-53] **D.Lgs. 14 settembre 2015, n. 137** — *Sicurezza nazionale e applicazione D.L. 21/2012*.

[N-54] **Strategia Nazionale Spazio 2023** — Coordinamento Politiche Economiche Presidenza Consiglio.

[N-55] **Piano Spaziale Nazionale 2023-2026** — ASI + MIMIT.

[N-56] **EU Strategic Compass 2022** + **EU Drone Strategy 2.0 (COM(2022) 652 final)** — Posizionamento UE difesa + drone.

## R.1.9 Codice Penale rilevante

[N-57] **Codice Penale art. 432-bis** — *Attentati alla sicurezza dei trasporti aerei* (dolosi + colposi connessi art. 449).
...
[N-59] **D.Lgs. 9 aprile 2008, n. 81 — Testo Unico Sicurezza Lavoro** — Applicabile a operazioni Firmamento (incluso Titolo XI ATEX per hangar).
...
[N-61] **Elenco Aree SNAI 2014-2020 + 2021-2027** — politichecoesione.governo.it. [link](https://politichecoesione.governo.it/media/rpipea3z/elenco_aree_snai_14-20-e-21-27_20231012.pdf).

[N-62] **Dossier SNAI Regione Liguria** — politichecoesione.governo.it. [link](https://politichecoesione.governo.it/media/3171/snai-dossier-regionale-liguria.pdf).
...
[N-64] **Comune di Torriglia** — Anagrafica frazione Pentema (14 abitanti ISTAT). Source: WebSearch verifica + [italia.indettaglio.it](https://italia.indettaglio.it/ita/liguria/genova_torriglia_pentema.html). Confidence: **high**.
...
[N-68] **European Union Aviation Safety Agency (EASA)** — Cologna, DE. UAS Department + Innovation Network.

[N-69] **European Defence Agency (EDA)**.

[N-70] **EUROCONTROL** — Network Manager Functions per ATM-ANS coordinamento.
...
Per la presentazione a bandi pubblici italiani, il documento dichiara conformità a:

- **D.Lgs. 36/2023 art. 41 + Allegato I.7** (PFTE)
- **AS/EN 9100** (Quality Management Aerospace) — vedi R.2
- **ISO 9001:2015** (Quality Management generale)
...
- N-45 IRIS² — confermato LEO+MEO puro, NO layer stratosferico (DR-009)
