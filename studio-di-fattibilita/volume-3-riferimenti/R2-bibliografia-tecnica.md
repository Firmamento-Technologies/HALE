...
> Sezione R.2: Standard tecnici aerospaziali, metodologie di systems engineering, comunicazioni
...
[T-31] **JARUS SORA 2.5** (Joint Authorities for Rulemaking on Unmanned Systems), *Specific Operations Risk Assessment v2.5*, ottobre 2024. [JARUS-RPAS](http://jarus-rpas.org). Confidence: **high**.
- 10 step SORA
...
[T-47] **3GPP Rel-17 to Rel-19**, NR-NTN Work Items (LEO, GEO, HAPS, regenerative payloads). [3GPP NTN Overview](https://www.3gpp.org/technologies/ntn-overview).
...
[T-55] **Selig SD7037 / SD8000**, profili low-Re per UAV stratosferici. [UIUC Airfoil Database](https://m-selig.ae.illinois.edu/ads.html).
...
[T-63] **CompositesWorld**, articoli su Biogear (Fuko + Turtle), carrello di atterraggio elicotteristico ibrido CFRP+lino, riduzione di peso del 54% rispetto al metallico. [CompositesWorld Biogear](https://www.compositesworld.com/articles/carbon-fiberflax-landing-gear-achieves-54-weight-reduction-via-tailored-layup-optimization).

[T-64] **Springer**, *Flax fiber for aerospace applications: a review of qualification status* (2024). [DOI: 10.1007/s10443-024-10296-z](https://link.springer.com/article/10.1007/s10443-024-10296-z).
...
[T-71] **ESA Copernicus Sentinel**, specifiche tecniche Sentinel-1 / 2 / 3 / 5p / 6. [Copernicus Sentinels](https://sentinels.copernicus.eu/).
