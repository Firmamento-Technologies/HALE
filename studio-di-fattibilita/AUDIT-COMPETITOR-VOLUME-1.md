...
| 4 | **IRIS² (EU sovereign satcom)** | Assorbimento concettuale "HAPS = layer accessorio satellitare"; consorzio Airbus-Eutelsat-Thales blocca HAPS narrative | M-H | Y3-Y6 | **H** per boundary B2 — uccide "EU sovereign stratospheric layer" come categoria autonoma |
...
- **Probabilità**: H (~55-70%) — è la mossa naturale di un incumbent. Le PMI aerospace IT che diventano visibili senza capital structure resistente sono storicamente acquisite (vedi storia Tellumat → Leonardo, Sitael ecosystem).
...
- **Descrizione**: IRIS² (in implementazione 2024-2030) consolida governance EU sovereign satellite. Consortium Airbus-Eutelsat-Thales-Telespazio-Hispasat-OHB-DT-Orange. Bruxelles posiziona "HAPS = layer accessorio LEO/MEO/GEO architecture", NON categoria autonoma. Conseguenza: nessun programma EU sovereign HAPS dedicato; HAPS budget viene allocato dentro IRIS² governance (con vincitori IRIS² come gatekeeper).
...
- EDF call HAPS €100-300M next: 2027-2029 (Y2-Y4). Pubblicazione call ≠ vincita.
...
**Realisticamente** al M+24 il funding mix Phase B sarà 20-35%, non 50%. Trigger automatico = Defer 6B a M+36 (Cap. 10 §10.4.4 scenario). Il "Hold" diventa "Defer permanente di facto".
...
2. Cap. 11 pubblico chiude a Fase 4 con €100-500M capital intensity "small-medium fleet". Fase 5 = "EU consortium leadership" senza capital intensity quantificato.
...
Realisticamente: EDF HAPS Fase 4 = participazione subordinata in consortium TAS-Leonardo-Airbus lead, con €5-15M (non €50-200M lead) per Firmamento. Non sufficiente a finanziare costellazione 3-10 HAPS.
...
Realisticamente Y2 ARR €0.5-1M, fleet 1-2 UAS, team 8-12 FTE. Gate Fase 2 = parziale → Cap. 11 dice "KPI parziali = Hold scale-up". 
...
A quel punto, "IPO indipendente" è decisione del board (dominato da CDP + VC EU), non del founder. Probabilità IPO standalone vs strategic consolidation (opzione 2/3) = 30/70 storicamente. Cap. 11 mette IPO come "preferred" ma in pratica il founder ha controllo limitato al M+96.
...
Sul Percorso 6B HALE stratosferico e sulla boundary B2 EU sovereign (Cap. 11) lo Studio è **epistemicamente onesto ma operativamente fragile**: la roadmap dichiara le dipendenze esterne (EU programma sovrano, batterie 350 Wh/kg, EASA Special Condition) ma non offre piano credibile per realizzarle. Realisticamente Phase B 6B inizia con funding mix ~25-35% al M+24 (non 50% richiesto), gate G5 = Defer, Firmamento si attesta su scala "operator IT" senza scala EU.
